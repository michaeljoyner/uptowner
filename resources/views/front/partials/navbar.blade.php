<div class="hidden main-navbar flex flex-spaced bg-col sticky-top flex-center-y">
    <div class="nav-branding flex-static flex flex-center pl-7">
        <a href="/"><img src="/images/logos/logo_white.svg" class="hover-shake" alt="Uptowner Taichung Logo" width="150px"></a>
    </div>
    ...
    <label for="nav-trigger" class="text-colour-light pr-7 mobile-only-block">@include('svgicons.menu')</label>
</div>