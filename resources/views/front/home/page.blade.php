...
<section class="flex-col flex-center-y pd-y-10">
...
<section class="favorites bg-covered pd-y-10 flex-col flex-center-y">
    ...
    <div class="w-con mg-x-a grid col-4 mt-9 mb-10">
        @foreach($favourites as $item)
            <div class="pd-2 rounded-1 bg-light flex-col flex-spaced mg-x-a">
                ...
                <p class="pl-2 h5 text-colour">NT${{ $item->price }}</p>
            </div>
        @endforeach
    </div>
    ...
    <section class="specials bg-pattern-grey pd-y-9">
        ...
        <div data-flickity='{"imagesLoaded": true}' class="w-con-800 mg-x-a mt-9">
            ...
            <div class="flex-col flex-center-y">
                ...
                <p class="body-text mt-1">{{ $special->description }}</p>
    ...
    <section class="bg-col pb-10 pt-11">
    ...
    <section class="flex flex-space bg-col pd-y-10 text-colour-light text-center">
